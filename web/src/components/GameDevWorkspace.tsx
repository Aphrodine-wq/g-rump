...
export default function GameDevWorkspace({ 
  ...
  const handleCompile = async () => {
    ...
    try {
      ...
      // Note: In a real environment, you would need to set up the WASM build pipeline
      // and import the pkg/grump_compiler.js generated by wasm-pack.
      
      const useWasm = false; // Set to true once wasm-pack build is integrated into Vite
