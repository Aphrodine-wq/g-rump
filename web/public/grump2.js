...
if (!face) return; // Exit if face not found
...
const idles = [
  ...
  ()=> root.style.setProperty('--eyebrow-left-rotate', rand(-15,-5)+'deg'),
  ()=> root.style.setProperty('--eyebrow-right-rotate', rand(5,15)+'deg'),
  ...
  ()=> { eyes.forEach(e=>e.style.transform='scaleY(0.05)'); setTimeout(()=>eyes.forEach(e=>e.style.transform=''),250); },
  ()=> { eyes.forEach(e=>e.style.transform='scaleY(0.5)'); setTimeout(()=>eyes.forEach(e=>e.style.transform=''),150); },
  ()=> { eyes[0].style.transform='scaleY(0.1)'; setTimeout(()=>eyes[0].style.transform='',100); setTimeout(()=>{eyes[1].style.transform='scaleY(0.1)'; setTimeout(()=>eyes[1].style.transform='',100);},150); },
